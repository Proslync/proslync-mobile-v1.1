...
// Original path: components/bar/tab-status-badge.tsx
// Inlined BarTabStatus type so the file is self-contained — v1's
// `lib/types/bar-tab.types` didn't make the migration.
