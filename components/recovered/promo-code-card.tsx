...
// Original path: components/pricing/promo-code-card.tsx
// Inlined: PromoCode type + formatShortDate. ConfirmSheet usage removed for
// the recovered version — preview is presentational only.
...
const styles = StyleSheet.create({
  ...
  codeInfo: { flex: 1, marginRight: 12 },
  code: { fontSize: 16, letterSpacing: 1 },
  discount: { fontSize: 13, marginTop: 2 },
  detailsRow: { marginTop: 10, gap: 2 },
