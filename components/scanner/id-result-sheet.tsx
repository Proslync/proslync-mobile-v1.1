  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        {/* Ticket status badge */}
        {ticketBadge && (
          <View style={[styles.ticketBadge, { backgroundColor: ticketBadge.bg }]}>
            <Ionicons
              name={idResult.ticketStatus === 'found' || idResult.ticketStatus === 'rsvp' ? 'ticket-outline' : 'alert-circle-outline'}
              size={14}
              color={ticketBadge.color}
            />
            <Text style={[styles.ticketBadgeText, { color: ticketBadge.color }]}>
              {ticketBadge.label}
            </Text>
            {idResult.ticketInfo && idResult.ticketStatus === 'found' && (
              <Text style={[styles.ticketBadgeDetail, { color: ticketBadge.color }]}>
                {idResult.ticketInfo}
              </Text>
            )}
          </View>
