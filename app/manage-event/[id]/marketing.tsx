...
const styles = StyleSheet.create({
  ...
  emptyCreateText: { fontSize: 14, },
  promoGroup: { marginBottom: 20 },
  groupLabel: { fontSize: 12, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10 },
  ...
  promoCode: { fontSize: 18, letterSpacing: 1.5 },
  promoDiscount: { fontSize: 14, marginTop: 2 },
