...
import { useAllAttendees, useDebounce } from '@/hooks';
...
export default function AllAttendeesScreen() {
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <Text style={[styles.headerTitle, { color: colors.text }]}>All Attendees</Text>
          {!isLoading && (
